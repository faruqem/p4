    ...
    <div class="container">
        ...
        <form method='POST' action='/revisions/{{ $revision->id }}'>
            ...
            <div class='form-group'>
                <label for="term">Revision</label>
                <textarea type='text' id='description' class="form-control" name='description'>{{ old('description', $revision->description) }}</textarea>
            ...
            <div class='form-group'>
                ...
                <select name='report_id' id='report_id'>
                    @foreach($reports_for_dropdown as $report_id => $report)
                        <option {{ ($report_id == $revision->report->id) ? 'SELECTED' : '' }} value='{{ $report_id }}'>{{ $report }}</option>
                    @endforeach
                </select>
            </div>
